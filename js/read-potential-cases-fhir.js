...
(async () => {
  ...
  await fs.writeFile("alcohol-consumption-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("alcohol-consumption-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
